...
<body>
	...
	<div class="footer-left">
		...
		<p class="footer-links">
			<a href="<c:url value="/index1"/>">Accueil</a> · <a
				href="<c:url value="/aboutus"/>">A propos de nous </a> · <a href="<c:url value="/getAllProducts" />">Produits
				</a> · <a href="<c:url value="/contactus"/>">Contactez-nous</a>
		</p>

		<p>Développé par: AMINE EL KHOUMISSI &copy; 2017</p>
	</div>
	</footer>
</body>
</html>